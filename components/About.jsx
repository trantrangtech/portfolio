...
const qualificationData=[
    {
        ...
        data:[
            {
                university:'Ho Chi Minh City University of Industry and Trade (Previously known as University of Food Industry in Ho Chi Minh City)',
    ...
    },
    {
        ...
        data:[
            {
                company:'FERYA COMPANYLIMITED',
                role:'Software Developer',
                years:'2017 - 2018',
            },
            {
                company:'ELCOM PRIME JOINT-STOCK COMPANY',
                role:'Product Development Specialist',
                years:'2018 - 2021',
            },
            {
                company:'FACTORY360 TECHNOLOGY AND INFORMATICS SOLUTIONS COMPANY LIMITED',
                                ...
                                <TabsContent value="personal">
                                    <div className="text-center xl:text-left">
                                        ...
                                        <p className="subtitle max-w-xl mx-auto xl:mx-0">
                                            I specialize in crafting intuitive websites with cutting-edge technology, delivering a seamless user experience that is both visually appealing and easy to navigate. I have a strong passion for web development and design, and I am always looking for new ways to improve my skills and stay up-to-date with the latest trends in the industry.
                                        </p>
